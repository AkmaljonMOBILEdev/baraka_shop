import 'dart:io';
import 'package:baraka_shop/ui/tab_box/profile/widget/update_button.dart';
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            style: ButtonStyle(
              backgroundColor:
                  MaterialStatePropertyAll<Color>(AppColors.c040415),
            ),
            onPressed: () {
              _uploadImage();
              context
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    style: const ButtonStyle(
                        backgroundColor:
                            MaterialStatePropertyAll<Color>(AppColors.cFC6828)),
                    onPressed: () {
                      _uploadImage();
                      context
                          .read<ProfileProvider>()
